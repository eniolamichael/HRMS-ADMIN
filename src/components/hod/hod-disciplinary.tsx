...
export default function HodDisciplinary() {
  const { teamDisciplinaryCases, addCaseComment, caseComments, hodName } = useHod();
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Cases involving your team — view, comment, and escalate as permitted
        </p>
      </div>
