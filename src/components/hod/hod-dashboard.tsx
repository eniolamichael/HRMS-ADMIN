...
export default function HodDashboard() {
  ...
  const onLeave = teamMembers.filter((e) => e.status === "on_leave").length;
  ...
  const stats = [
    { label: "Team Members", value: teamMembers.length, icon: Users, color: "text-blue-600 bg-blue-100" },
    { label: "Pending Approvals", value: approvalTasks.length, icon: Inbox, color: "text-emerald-600 bg-emerald-100" },
    { label: "Pending Leave", value: pendingLeaves, icon: CalendarClock, color: "text-amber-600 bg-amber-100" },
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold text-gray-900">
          Welcome, {hodName.split(" ")[0]}
        </h1>
        <p className="text-sm text-gray-500 mt-1">
          {departmentName} Department — overview of your team and pending actions
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-gray-200 shadow-sm">
          <div className="px-5 py-4 border-b">
            ...
            <p className="text-xs text-gray-500">Team leave requests</p>
          </div>
          <ul className="divide-y">
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">
                    {teamPromotionRequests.length} promotion request(s)
                  </p>
                  <p className="text-xs text-gray-500">within your reporting line</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">involving your team</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">in your reporting scope</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-emerald-600 to-teal-700 rounded-xl p-5 text-white shadow-sm">
            ...
            <p className="text-sm text-emerald-100 mt-1">
              Employees reporting to you in {departmentName}
            </p>
          </div>
        </div>
      </div>
