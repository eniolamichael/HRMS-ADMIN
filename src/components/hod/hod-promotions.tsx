...
export default function HodPromotions() {
  const {
  ...
  const submit = () => {
    ...
    if (editingId) {
      // Update path - find and update
      requestPromotion(payload); // for edits we recreate (mock)
      deletePromotionRequest(editingId);
    } else {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            View and initiate promotions for employees in your scope
          </p>
        </div>
        ...
        <TabsContent value="history" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Completed promotions for your team</CardDescription>
            </CardHeader>
            <CardContent>
