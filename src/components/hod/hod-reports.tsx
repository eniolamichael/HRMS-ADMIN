      ...
      <Tabs defaultValue="reports">
        <TabsList>
          ...
          <TabsTrigger value="notifications">
            Notifications ({hodNotifications.filter((n) => !n.isRead).length})
          </TabsTrigger>
        ...
        <TabsContent value="reports" className="mt-4">
          <div className="flex items-center gap-2 mb-4 text-xs text-gray-500">
            ...
            Only reports where the report and underlying data are authorized for {hodName} ({departmentName})
          </div>
