...
export default function SupervisorExitRequests() {
  const { teamExitRequests, approveExit, supervisorName } = useSupervisor();
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Exit requests within your direct reporting scope ({supervisorName})
        </p>
      </div>
