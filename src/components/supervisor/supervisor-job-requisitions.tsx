...
export default function SupervisorJobRequisitions() {
  const {
    myRequisitions,
    saveRequisition,
    updateRequisition,
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Raise requisitions for vacant roles in {departmentName} ({supervisorName})
          </p>
        </div>
            ...
            <div>
              ...
              {policyId && (
                <p className="text-xs text-gray-400 mt-1">
                  Approval: {requisitionPolicies.find((p) => p.id === policyId)?.approvalWorkflowName}
                </p>
              )}
            </div>
            <div>
